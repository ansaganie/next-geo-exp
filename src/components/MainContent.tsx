  ...
  return (
    <main className="flex-1">
      <div className="space-y-12">
        {/* Hero Section */}
        <section id="top" className="py-20 text-center bg-gradient-to-b from-primary/5 to-background">
          <div className="container">
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl text-primary">
              GeoExploration
            </h1>
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
              Профессиональные геологические и геодезические услуги в Казахстане.
              Бурение скважин, инженерно-геологические изыскания, топографические
              съемки.
            </p>
          </div>
        </section>
        ...
        <section id="services" className="py-20 bg-muted/30">
          <div className="container">
            <h2 className="text-3xl font-bold text-center mb-12 text-primary">Наши услуги</h2>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[...Array(6)].map((_, i) => (
                <Card key={i} className="hover:shadow-lg transition-shadow border-primary/10">
                  <CardHeader>
                    <CardTitle className="text-primary">Услуга {i + 1}</CardTitle>
                    <CardDescription>
        ...
        <section id="about" className="py-20">
          <div className="container">
            <div className="grid gap-12 md:grid-cols-2">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-primary">О компании</h2>
        ...
        <section id="portfolio" className="py-20 bg-muted/30">
          <div className="container">
            <h2 className="text-3xl font-bold text-center mb-12 text-primary">Наши работы</h2>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[...Array(6)].map((_, i) => (
                <Card key={i} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <CardTitle className="text-primary">Проект {i + 1}</CardTitle>
                    <CardDescription>
        ...
        <section id="video" className="py-20">
          <div className="container">
            <h2 className="text-3xl font-bold text-center mb-12 text-primary">Видео отзывы</h2>
